...
%
% This script used to forward simulate BRF.
% _______________________________________________________________________
% ***********************************************************************
...
% ***********************************************************************
% This script allows to simulate BRF based on the PROSPECT-PRO model (Féret et al. 2021)
...
function BRF=prospecular(a,wave,xr)
% a: surface structure and biochemical parameters of PROSPECULAR model;
...
%BRF=diffuse component +specular component
BRF=R+brdfj'.*pi;
end
